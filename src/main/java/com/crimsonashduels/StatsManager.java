...
public class StatsManager {
    ...
    public int getDuels(Player player) {
        return duels.getOrDefault(player.getUniqueId(), 0);
    }
    ...
    public void addDuel(Player player) {
        duels.put(player.getUniqueId(), getDuels(player) + 1);
    }
